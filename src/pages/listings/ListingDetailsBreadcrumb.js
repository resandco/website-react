    ...
    return (
        <>
            <section
                ...
                style={{
                    backgroundImage: `url("${restaurant.image}?tr=w-1920")`,
                }}
                data-zob="truc"
            >
                            ...
                            <div className="col-lg-12 position-relative">
                                <div className="breadcrumb-content">
                                        ...
                                        {restaurant.verifie ? (
                                            <span className="author-verified-badge">
                                                <span
                                                    ...
                                                    data-toggle="tooltip"
                                                    data-placement="top"
                                                    title="Le restaurant a été testé et validé en personne par un membre de notre équipe"
                                                >
                                    ...
                                    <p className="breadcrumb__desc">
                                        ...
                                        {restaurant.stitle}, {restaurant.scity}
                                    </p>
