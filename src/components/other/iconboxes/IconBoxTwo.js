        ...
        items: [
            {
                ...
                desc:
                    'En découvrant de nouvelles saveurs et en se laissant surprendre par un menu original préparé par tes restaurateurs',
            },
            {
                id: 2,
                icon: <GiAirplane />,
                ...
                desc:
                    'En leur apportant ton soutien pour surmonter la crise sanitaire et leur permettre de ne rien jeter',
            },
            {
                id: 3,
                icon: <FiPercent />,
                ...
                desc:
                    'En profitant de tarifs réduits. Jusqu’à 64% de réduction par rapport aux menus habituels',
            },
            {
                id: 4,
                icon: <GiEcology />,
                ...
                desc:
                    'En nous aidant à réduire le gaspillage alimentaire mondial',
            },
        ],
    }
    render() {
